...
Chain_model = function(p, m = floor(p/20), subblock = "sparse", sparse.prob = 0.4, equal.element = 0.6){
  n.groups = floor(p/m)
...
#     X      ------ n x p data matrix
#-----------------------------------------------------------------------------------------------------------
Generate_XZ = function(n, p, m = floor(p/20), k = 4, prec.type = 1, mu = NULL, g.type = 1, sparse.prob = 0.8, equal.element = 0.9,
